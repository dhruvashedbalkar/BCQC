            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
              <GlassCard className="p-8 border-primary/20">
                ...
                <div className="space-y-6">
                  <Button className="w-full h-12 text-base glow-purple flex items-center justify-center gap-2 bg-[#333] hover:bg-[#444] text-white">
                    <Wallet size={20} />
                    Connect Wallet
                  </Button>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="email" placeholder="student@university.edu" className="h-11 bg-background/50" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="password">Password</Label>
                      <Input id="password" type="password" className="h-11 bg-background/50" />
                    </div>
                    <Button className="w-full h-11 glow-blue">
